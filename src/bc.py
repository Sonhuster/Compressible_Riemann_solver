...
# --------------------------Boundary condition------------------------------ #
lid_driven_cavity = {
        'top_face':   {'u': ['dirichlet', u_inf], 'v': ['dirichlet', v_inf], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'bot_face':   {'u': ['dirichlet', 0], 'v': ['dirichlet', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'left_face':  {'u': ['dirichlet', 0], 'v': ['dirichlet', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'right_face': {'u': ['dirichlet', 0], 'v': ['dirichlet', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]}
    }

airfoil_flow = {
        'mainwing_face':   {'u': ['dirichlet', 0], 'v': ['dirichlet', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'slatwing_face':   {'u': ['dirichlet', 0], 'v': ['dirichlet', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'flapwing_face':   {'u': ['dirichlet', 0], 'v': ['dirichlet', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},

        'top_face':   {'u': ['neumann', 0], 'v': ['neumann', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'bot_face':   {'u': ['neumann', 0], 'v': ['neumann', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'left_face':  {'u': ['dirichlet', u_inf], 'v': ['dirichlet', v_inf], 'p': ['neumann', 0], 'T': ['neumann', 0]},
        'right_face': {'u': ['neumann', 0], 'v': ['neumann', 0], 'p': ['neumann', 0], 'T': ['neumann', 0]}
    }

channel_flow = {
        'top_face':   {'u': ['dirichlet', 0],       'v': ['dirichlet', 0],      'p': ['neumann', 0], 'T': ['neumann', 0]},
        'bot_face':   {'u': ['dirichlet', 0],       'v': ['dirichlet', 0],      'p': ['neumann', 0], 'T': ['neumann', 0]},
        'left_face':  {'u': ['dirichlet', u_inf],   'v': ['dirichlet', v_inf],  'p': ['neumann', 0], 'T': ['neumann', 0]},
        'right_face': {'u': ['neumann', 0],         'v': ['neumann', 0],        'p': ['neumann', 0], 'T': ['neumann', 0]}
    }
...
def set_bc(mesh, var, SIMULATION_MODE):
        ...
        for face_patch in face_patches.keys():
            ...
            for var_str, [bc_type, bc_value] in face_patches[face_patch].items():
                ...
                if bc_type == 'dirichlet':
                    ...
                    continue
        [(error_uv, error_vv, error_pv), (var_uv_old, var_vv_old, var_pv_old)] = sol.cal_outer_res((var.uv, var_uv_old), (var.vv, var_vv_old), (var.pv, var_pv_old))
        [(error_ubc, error_vbc, error_pbc), (var_ubc_old, var_vbc_old, var_pbc_old)] = sol.cal_outer_res((var.ubc, var_ubc_old), (var.vbc, var_vbc_old), (var.pbc, var_pbc_old))
    ...
    var.rhobc = shr * var.pbc / var.Tbc
    var.rhoc = shr * var.pc / var.Tc
    var.rhof = shr * var.pf / var.Tf
    var.rhov = shr * var.pv / var.Tv
